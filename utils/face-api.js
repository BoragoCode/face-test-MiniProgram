(function (global, factory) {
    ...
    */
    ...
    //     if (isClosed === void 0) { isClosed = false; }
        ...
        //     var x = _a.x, y = _a.y;
        //     var from = points[prevIdx];
        //     ctx.setShadow(0, 100, 80, '#f1173a')
        //     // ctx.moveTo(from.x, from.y);
        //     if(prevIdx==6){
        //         ctx.lineTo(from.x, from.y-8);
        //         ctx.lineTo(from.x-8, from.y-6);
        //     }else{
        //         ctx.lineTo(from.x, from.y-4);
        //     }
        //     // ctx.lineTo(x, y);
        // });
        // if (isClosed) {
        ...
        // ctx.setFillStyle('rgba(213,77,79,.7)')
        // ctx.fill()
        //将点连线
        // ctx.stroke();
    // }
    ...
    var FaceLandmarks68 = /** @class */ (function (_super) {
        ...
        FaceLandmarks68.prototype.getMouth1 = function () {
            let _p1 = this.positions.slice(48, 55);
            let _p2 = this.positions.slice(60, 64);
            _p2 = _p2.reverse();
            let _p = _p1.concat(_p2)
            return _p;
        };
        FaceLandmarks68.prototype.getMouth2 = function () {
            return this.positions.slice(48, 68);
        };
    ...
    function drawFaceLandmarks(canvasArg, faceLandmarks,DrawParameter) {
        ...
        faceLandmarksArray.forEach(function (f) {
            ...
            if(DrawParameter){
                new DrawFaceLandmarks(landmarks,DrawParameter).draw(canvasArg);
            }else{
